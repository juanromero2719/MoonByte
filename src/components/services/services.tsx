...
export default function Servicios({ id }: { id?: string }) {
    return (
        <section id={id} className="pt-16 sm:py-16 px-4 bg-white mb-10 sm:mb-0 md:mb-20 lg:mb-10">
            <div className="max-w-7xl mx-auto text-center">
                <h2 className="text-4xl sm:text-5xl lg:text-6xl font-semibold text-[#14213d] mb-20 lg:mb-30">Servicios</h2>
